...
>
          ...
          <h2 className="mt-5 text-4xl lg:text-5xl font-bold text-[#071426] text-center">
            We're Here To
        ...
        <div className="w-full max-w-[1800px] mx-auto grid md:grid-cols-2 xl:grid-cols-4 gap-8">
